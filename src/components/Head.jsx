...
const toggleMenuHandler = () => {
  ...
  return (
    <div className="flex justify-between items-center px-1 md:px-5  dark:bg-gray-900  py-1 md:py-2 lg:py-3 bg-neutral-50 shadow-sm rounded-tl-4xl rounded-r-4xl">
